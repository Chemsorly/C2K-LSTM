...
namespace Analyser
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //target folders
            DirectoryInfo InFolder = new DirectoryInfo(@"Y:\Sicherung\Adrian\Sync\Sciebo\MA RNN-LSTM Results\archive\1 Leg\raw");
            DirectoryInfo ResultsFolder = new DirectoryInfo(@"Y:\Sicherung\Adrian\Sync\Sciebo\MA RNN-LSTM Results\archive\1 Leg\");
