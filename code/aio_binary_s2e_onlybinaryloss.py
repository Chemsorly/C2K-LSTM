...
model.compile(loss={'violation_output':'categorical_crossentropy'}, optimizer=opt)
...
#train
model.fit(X, {'violation_output':y_v}, validation_split=0.2, verbose=2, callbacks=[early_stopping, model_checkpoint, lr_reducer], batch_size=maxlen, nb_epoch=500)
