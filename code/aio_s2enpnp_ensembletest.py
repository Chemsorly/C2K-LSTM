...
# pick random 
print('{} elements before bagging'.format(len(lines)))
intermediatelines = []
intermediatelines_t = []
intermediatelines_t2 = []
intermediatelines_t3 = []
intermediatelines_t4 = []
intermediatelines_t5 = []
intermediatelines_t6 = []
intermediatelines_t7 = []
for i in range(int(round(bagging_size * len(lines)))):
    num = random.randint(0, len(lines) - 1)
    intermediatelines.append(lines[num])
    intermediatelines_t.append(lines_t[num])
    intermediatelines_t2.append(lines_t2[num])
    intermediatelines_t3.append(lines_t3[num])
    intermediatelines_t4.append(lines_t4[num])
    intermediatelines_t5.append(lines_t5[num])
    intermediatelines_t6.append(lines_t6[num])
    intermediatelines_t7.append(lines_t7[num])
lines = intermediatelines 
lines_t = intermediatelines_t
lines_t2 = intermediatelines_t2
lines_t3 = intermediatelines_t3
lines_t4 = intermediatelines_t4
lines_t5 = intermediatelines_t5
lines_t6 = intermediatelines_t6
lines_t7 = intermediatelines_t7
print('{} elements after bagging'.format(len(lines)))
